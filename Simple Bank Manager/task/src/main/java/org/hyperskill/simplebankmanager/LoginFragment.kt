...
class LoginFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener {
            val enteredName = view.findViewById<EditText>(R.id.loginUsername).text.toString()
            val enteredPass = view.findViewById<EditText>(R.id.loginPassword).text.toString()
            if(enteredName == correctUsername && enteredPass == correctPassword) {
                Toast.makeText(context, "logged in", Toast.LENGTH_SHORT).show()
                findNavController().navigate(R.id.action_loginFragment_to_userMenuFragment,
                    bundleOf("username" to enteredName))
